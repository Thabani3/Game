    ...
    public partial class Form4 : Form
    {
        ...
        private void MainTimeEvent(object sender, EventArgs e)
        {
            ...
            if (player.Bounds.IntersectsWith(door.Bounds) && hasKey == true && score >= 20)
            {
                ...
                GameTimer.Stop();
                sp2.SoundLocation = "C:/Users/HP/Desktop/Game Project/Game Project/bin/Debug/unlocks.wav";
                sp2.Play();
                MessageBox.Show("Well Done!! Level Complete!" + Environment.NewLine + "Click OK to play again!");
            ...
            {
                sp3.SoundLocation = "C:/Users/HP/Desktop/Game Project/Game Project/bin/Debug/diying.wav";
                sp3.Play();
                GameTimer.Stop();
